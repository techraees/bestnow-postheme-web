...
const ShivaCartoonUI = () => {
  ...
  return (
    <>
      <div className="max-w-md mx-auto text-black h-screen font-sans p-4 pt-0 pb-[10rem] overflow-y-auto relative lg:hidden block">
        <div className="flex items-center justify-between sticky top-0 z-[1000] p-4 px-0 dark:bg-dark_mode_primary bg-light_mode_primary">
          <div className="flex items-center gap-2 text-black dark:text-white text-lg font-semibold">
            <div>
              <Image
                src={
            ...
            <div>
              ...
              <div className="text-xs text-gray-600 dark:text-dark_mode_gray_color">
                Active Users
              </div>
            </div>
          </div>
